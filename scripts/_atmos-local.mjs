...
await page.goto("http://127.0.0.1:8765/examples/threejs-atmosphere-aerial-perspective/lut-aerial-perspective/", { waitUntil: "domcontentloaded", timeout: 30000 });
...
console.log("Atmosphere ready:", ready);
