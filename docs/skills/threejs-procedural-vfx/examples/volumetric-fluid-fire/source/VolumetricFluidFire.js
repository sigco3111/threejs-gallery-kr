...
import * as THREE2 from "https://esm.sh/three@0.185.1?external/webgpu";
...
import { float as float2, globalId as globalId2, If as If3, ivec3, Return as Return2, vec3 as vec33, vec4 as vec43 } from "https://esm.sh/three@0.185.1?external/tsl";
...
import { float as float4, max, min as min2, smoothstep as smoothstep2, vec3 as vec35, vec4 as vec45 } from "https://esm.sh/three@0.185.1?external/tsl";

// docs/skills/threejs-procedural-vfx/examples/volumetric-fluid-fire/source/pass/vorticityPass.ts
import { cross, length as length2, vec3 as vec34, vec4 as vec44 } from "https://esm.sh/three@0.185.1?external/tsl";
...
import { dot, select, vec3 as vec36, vec4 as vec46 } from "https://esm.sh/three@0.185.1?external/tsl";
...
import { float as float6, If as If6, vec3 as vec37, vec4 as vec47 } from "https://esm.sh/three@0.185.1?external/tsl";
...
import { float as float7, If as If7, vec3 as vec38, vec4 as vec48 } from "https://esm.sh/three@0.185.1?external/tsl";
...
import { float as float8, floor, If as If8, max as max3, vec3 as vec39, vec4 as vec49 } from "https://esm.sh/three@0.185.1?external/tsl";
...
// docs/skills/threejs-procedural-vfx/examples/volumetric-fluid-fire/source/pass/emitObjectPass.ts
import {
  float as float9,
  If as If9,
  max as max4,
...
// docs/skills/threejs-procedural-vfx/examples/volumetric-fluid-fire/source/VolumetricFluidFire.ts
import { gaussianBlur } from "https://esm.sh/three@0.185.1?external/addons/tsl/display/GaussianBlurNode.js";

// docs/skills/threejs-procedural-vfx/examples/volumetric-fluid-fire/source/sdf/CollisionHandler.ts
import { Matrix4 as Matrix43, Quaternion, Vector3 as Vector33 } from "https://esm.sh/three@0.185.1?external/webgpu";
import { cross as cross2, dot as dot3, float as float10, If as If10, Loop as Loop3, mat4, uint, uniform as uniform3, uniformArray as uniformArray3, vec3 as vec312, vec4 as vec411, normalize, mix as mix2 } from "https://esm.sh/three@0.185.1?external/tsl";

// docs/skills/threejs-procedural-vfx/examples/volumetric-fluid-fire/source/sdf/sdfSampler.ts
import { Fn as Fn6, vec3 as vec311 } from "https://esm.sh/three@0.185.1?external/tsl";
var sdfSampler = (fn) => {
...
import { uniformArray as uniformArray2 } from "https://esm.sh/three@0.185.1?external/tsl";
var ShapeIndex = 0;
var SDFShape = class {
...
import { abs as abs2, length as length4, max as max5, min as min4 } from "https://esm.sh/three@0.185.1?external/tsl";
...
import { length as length5 } from "https://esm.sh/three@0.185.1?external/tsl";
