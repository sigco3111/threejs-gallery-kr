...
import { float, globalId, If, ivec3, Return, vec3, vec4 } from "https://esm.sh/three@0.185.1/tsl?deps=three@0.185.1";
...
var curlNoisePass = (context) => () => {
  ...
  context.texture.curlNoise.write(coord, vec4(noiseVal, 0));
};
export {
  curlNoisePass
};
