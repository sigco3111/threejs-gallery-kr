...
// loop around the island. Must match the constants in tsl.js.
const MAIN_COLS = 160
...
export class ChainSim {
  constructor(coast) {
    ...
    this.texture = new THREE.DataTexture(this.texData, NODES, COLS, THREE.RGBAFormat, THREE.FloatType)
    this.texture.magFilter = THREE.NearestFilter
    this.texture.minFilter = THREE.NearestFilter
    this.texture.generateMipmaps = false
    this.texture.needsUpdate = true
    this.coastData = new Float32Array(COLS * 4)
    this.coastTexture = new THREE.DataTexture(this.coastData, COLS, 1, THREE.RGBAFormat, THREE.FloatType)
