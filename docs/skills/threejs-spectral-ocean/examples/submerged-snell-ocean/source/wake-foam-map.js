...
const WAKE_FOAM_CENTER_X = 0;
const WAKE_FOAM_CENTER_Z = 10;
const WAKE_FOAM_SIZE = 820;
const RESOLUTION = 1024;
const BITS = 10;
const MAX_SPLATS = 8;
const FRESH_TAU = 2.4;
const RESIDUE_TAU = 8.5;
const DIFFUSE_RATE = 1.1;
const BLEED_RATE = 4e-3;
const QUIET_AFTER = 35;
class WakeFoamMap {
  constructor() {
