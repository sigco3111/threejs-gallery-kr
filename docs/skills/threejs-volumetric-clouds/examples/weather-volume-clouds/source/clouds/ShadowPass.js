...
var ShadowMaterial2 = class extends (_a = RawShaderMaterial, _localWeatherChannels_dec = [defineExpression("LOCAL_WEATHER_CHANNELS", {
...
__decorateElement(_init, 5, "localWeatherChannels", _localWeatherChannels_dec, ShadowMaterial2);
__decorateElement(_init, 5, "cascadeCount", _cascadeCount_dec, ShadowMaterial2);
__decorateElement(_init, 5, "temporalPass", _temporalPass_dec, ShadowMaterial2);
__decorateElement(_init, 5, "temporalJitter", _temporalJitter_dec, ShadowMaterial2);
__decorateElement(_init, 5, "shapeDetail", _shapeDetail_dec, ShadowMaterial2);
__decorateElement(_init, 5, "turbulence", _turbulence_dec, ShadowMaterial2);
__decoratorMetadata(_init, ShadowMaterial2);
...
var ShadowResolveMaterial = class extends (_a2 = RawShaderMaterial, _cascadeCount_dec2 = [defineInt("CASCADE_COUNT", { min: 1, max: 4 })], _a2) {
  constructor({
    inputBuffer = null,
    historyBuffer = null
  } = {}) {
