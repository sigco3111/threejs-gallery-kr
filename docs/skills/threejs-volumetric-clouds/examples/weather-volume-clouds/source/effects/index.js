...
function checkGeometryIntersection(object, material, raycaster, ray, uv, uv1, normal, a, b, c2) {
...
var ClearPass = class extends Pass {
   ...
   */
  constructor(color2 = true, depth2 = true, stencil = false) {
   ...
   */
  setClearFlags(color2, depth2, stencil) {
    this.color = color2;
    this.depth = depth2;
    this.stencil = stencil;
  }
...
// docs/skills/threejs-volumetric-clouds/examples/weather-volume-clouds/source/effects/shaders/depthEffect.frag
...
// docs/skills/threejs-volumetric-clouds/examples/weather-volume-clouds/source/effects/DepthEffect.ts
...
var DepthEffect = class extends (_a = Effect, _useTurbo_dec = [define("USE_TURBO")], _a) {
  constructor(options) {
    ...
    __publicField(this, "useTurbo", __runInitializers(_init, 8, this)), __runInitializers(_init, 11, this);
...
// docs/skills/threejs-volumetric-clouds/examples/weather-volume-clouds/source/effects/shaders/ditheringEffect.frag
var ditheringEffect_default = "#define DITHERING\n\n#include <dithering_pars_fragment>\n\nvoid mainImage(const vec4 inputColor, const vec2 uv, out vec4 outputColor) {\n  outputColor = vec4(saturate(dithering(inputColor.rgb)), inputColor.a);\n}\n";

// docs/skills/threejs-volumetric-clouds/examples/weather-volume-clouds/source/effects/DitheringEffect.ts
...
// docs/skills/threejs-volumetric-clouds/examples/weather-volume-clouds/source/effects/setupMaterialsForGeometryPass.ts
...
// docs/skills/threejs-volumetric-clouds/examples/weather-volume-clouds/source/effects/shaders/downsampleThreshold.frag
...
// docs/skills/threejs-volumetric-clouds/examples/weather-volume-clouds/source/effects/shaders/downsampleThreshold.vert
...
// docs/skills/threejs-volumetric-clouds/examples/weather-volume-clouds/source/effects/DownsampleThresholdMaterial.ts
...
// docs/skills/threejs-volumetric-clouds/examples/weather-volume-clouds/source/effects/shaders/lensFlareFeatures.frag
...
// docs/skills/threejs-volumetric-clouds/examples/weather-volume-clouds/source/effects/shaders/lensFlareFeatures.vert
...
// docs/skills/threejs-volumetric-clouds/examples/weather-volume-clouds/source/effects/LensFlareFeaturesMaterial.ts
...
// docs/skills/threejs-volumetric-clouds/examples/weather-volume-clouds/source/effects/shaders/lensFlareEffect.frag
...
// docs/skills/threejs-volumetric-clouds/examples/weather-volume-clouds/source/effects/LensFlareEffect.ts
...
// docs/skills/threejs-volumetric-clouds/examples/weather-volume-clouds/source/effects/shaders/normalEffect.frag
...
// docs/skills/threejs-volumetric-clouds/examples/weather-volume-clouds/source/effects/NormalEffect.ts
...
var NormalEffect = class extends (_a2 = Effect, _octEncoded_dec = [define("OCT_ENCODED")], _reconstructFromDepth_dec = [define("RECONSTRUCT_FROM_DEPTH")], _a2) {
  constructor(camera, options) {
    ...
    this.camera = camera;
    __publicField(this, "octEncoded", __runInitializers(_init2, 8, this)), __runInitializers(_init2, 11, this);
    __publicField(this, "reconstructFromDepth", __runInitializers(_init2, 12, this)), __runInitializers(_init2, 15, this);
    if (camera != null) {
