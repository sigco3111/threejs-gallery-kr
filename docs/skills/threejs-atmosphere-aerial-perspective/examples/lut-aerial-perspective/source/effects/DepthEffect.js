...
import { depth, turbo } from "../geospatial/shaders/index.js";
import fragmentShader from "./shaders/depthEffect.frag?raw";
const depthEffectOptionsDefaults = {
  blendFunction: BlendFunction.SRC,
  useTurbo: false,
  near: 1,
  far: 1e3
};
class DepthEffect extends (_a = Effect, _useTurbo_dec = [define("USE_TURBO")], _a) {
  constructor(options) {
