...
class GpuCulledFlowerField {
  constructor(canvas, options, assets) {
    ...
    __publicField(this, "format", "bgra8unorm");
    __publicField(this, "uniformBuffer", null);
    __publicField(this, "visibleBuffers", []);
    __publicField(this, "visibleTiles", null);
    __publicField(this, "drawArgs", null);
    __publicField(this, "dispatchArgs", null);
    __publicField(this, "countReadback", null);
    __publicField(this, "depthTexture", null);
    __publicField(this, "grassTexture", null);
    __publicField(this, "petalTexture", null);
    __publicField(this, "sampler", null);
    __publicField(this, "pipelines", {});
    __publicField(this, "renderBindGroups", {});
    __publicField(this, "resetPipeline", null);
    __publicField(this, "flatCullPipeline", null);
    __publicField(this, "tileCullPipeline", null);
    __publicField(this, "hierarchicalCullPipeline", null);
    __publicField(this, "finalizePipeline", null);
    __publicField(this, "resetBindGroup", null);
    __publicField(this, "flatCullBindGroup", null);
    __publicField(this, "tileCullBindGroup", null);
    __publicField(this, "hierarchicalCullBindGroup", null);
    __publicField(this, "finalizeBindGroup", null);
    __publicField(this, "timestampQuery", null);
    __publicField(this, "timestampResolve", null);
    __publicField(this, "timestampReadback", null);
    __publicField(this, "cullTimestampQuery", null);
    __publicField(this, "cullTimestampResolve", null);
    __publicField(this, "cullTimestampReadback", null);
    __publicField(this, "timestampPending", false);
    __publicField(this, "cullTimestampPending", false);
    __publicField(this, "countPending", false);
    __publicField(this, "frameTimes", []);
    __publicField(this, "submitTimes", []);
    __publicField(this, "gpuRenderTimes", []);
    __publicField(this, "gpuCullTimes", []);
    __publicField(this, "visibleTiers", null);
    __publicField(this, "visibleTileCount", null);
    __publicField(this, "cullWallMs", null);
    __publicField(this, "cullStartedAt", 0);
    __publicField(this, "ready", false);
    __publicField(this, "disposed", false);
    __publicField(this, "cullDirty", true);
    __publicField(this, "error", null);
    __publicField(this, "lastFrame", 0);
    __publicField(this, "frameIndex", 0);
    __publicField(this, "maxGridSize", 2048);
    __publicField(this, "adapterLabel", "Unknown WebGPU adapter");
    __publicField(this, "lastViewProjection", null);
    __publicField(this, "interaction", { position: [1e5, 1e5], velocity: [0, 0], speed: 0, grounded: false });
    this.canvas = canvas;
