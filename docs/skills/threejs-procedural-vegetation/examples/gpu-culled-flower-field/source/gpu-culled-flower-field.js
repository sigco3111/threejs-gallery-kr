...
var GpuCulledFlowerField = class {
  ...
  renderBindGroups = {};
  resetPipeline = null;
  flatCullPipeline = null;
  tileCullPipeline = null;
  hierarchicalCullPipeline = null;
  finalizePipeline = null;
  resetBindGroup = null;
  flatCullBindGroup = null;
  tileCullBindGroup = null;
  hierarchicalCullBindGroup = null;
  finalizeBindGroup = null;
  timestampQuery = null;
  timestampResolve = null;
  timestampReadback = null;
  cullTimestampQuery = null;
  cullTimestampResolve = null;
  cullTimestampReadback = null;
  timestampPending = false;
  cullTimestampPending = false;
  countPending = false;
  frameTimes = [];
  submitTimes = [];
  gpuRenderTimes = [];
  ...
  frameIndex = 0;
  maxGridSize = 2048;
  adapterLabel = "Unknown WebGPU adapter";
  lastViewProjection = null;
  interaction = { position: [1e5, 1e5], velocity: [0, 0], speed: 0, grounded: false };
