// docs/examples/threejs-atmosphere-aerial-perspective/lut-aerial-perspective/source/effects/GeometryEffect.ts
...
var GeometryEffect = class extends Effect {
  constructor(options) {
    ...
    super(
      "GeometryEffect",
      resolveIncludes(geometryEffect_default, {
        core: { packing }
      }),
      {
        blendFunction,
