...
import { DirectionalLight, Matrix4 as Matrix43, Vector3 as Vector310 } from "https://esm.sh/three@0.185.1?external";
...
import { HalfFloatType as HalfFloatType2, Vector3 as Vector38 } from "https://esm.sh/three@0.185.1?external";
var vectorScratch13 = /* @__PURE__ */ new Vector38();
var vectorScratch23 = /* @__PURE__ */ new Vector38();
var vectorScratch32 = /* @__PURE__ */ new Vector38();
...
function getSunLightColor(transmittanceTexture, worldPosition, sunDirection, result = new Color(), {
  ...
  const camera = vectorScratch14.copy(worldPosition);
  if (correctAltitude) {
  ...
  const transmittance = vectorScratch24;
  let r = camera.length();
...
// docs/examples/threejs-atmosphere-aerial-perspective/lut-aerial-perspective/source/atmosphere/SunDirectionalLight.ts
var vectorScratch4 = /* @__PURE__ */ new Vector310();
...
var SunDirectionalLight = class extends DirectionalLight {
  ...
  update() {
    ...
    const cameraPositionECEF = this.target.getWorldPosition(vectorScratch4).applyMatrix4(inverseEllipsoidMatrix).sub(this.ellipsoidCenter);
    getSunLightColor(
